...
public class CustomerGto {
    ...
    public CustomerGto(String id, String titile, String name, String dob, Double salary, String address, String city, String province, String zip) {
        this.id = id;
        this.titile = titile;
        this.name = name;
        this.dob = dob;
    ...
    public boolean add(CustomerEntity ce) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
